            ...
            @case($user->id)
                <div class="grid mb-4">
                    <div class="justify-self-start flex">
                        ...
                        <div class=" rounded-xl bg-white pt-3 pb-4 px-5 max-w-md  md:break-words break-all">{{ $message->content }}</div>
                    </div>
                </div>
                @break
            @case($receiver->id)
                <div class="grid mb-4">
                    <div class="justify-self-end flex">
                        <div class=" rounded-xl bg-pink-500 text-white pt-3 pb-4 px-5 flex-1 md:break-words break-all">{{ $message->content }}</div>
